  ...
  return (
    <div className="flex items-center border border-border/60 rounded overflow-hidden h-8">
      <input
        ...
        className="w-14 bg-transparent px-2 text-[11px] font-mono text-foreground focus:outline-none focus:bg-card/60 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
      />
